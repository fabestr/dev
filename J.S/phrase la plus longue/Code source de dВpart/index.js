...
for (var i= 1; i < phrases.length; i++) {
    console.log('i au moment du tour de boucle', i);
    if (phrases[index].length < phrases[i].length) {

        index = i;
        console.log('la phrase était plus longue');
    }
    console.log('index', index)
}

console.log('la plus longue', phrases[index]);
...
document.write('la phrase la plus longue du tableau est donc:'+phrases[indexLongestPhrase]);
document.write('avec un nombre de caractère de:'+phrases[indexLongestPhrase].length);
